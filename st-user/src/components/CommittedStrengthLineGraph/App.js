...
const App = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        //const response = await fetch('http://localhost:5000/strength2');
        const response = await fetch(`${process.env.REACT_APP_API_URL}/cstrength4`);
        const data = await response.json();
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        //const response = await fetch('http://localhost:5000/strength2');
        const response = await fetch(`${process.env.REACT_APP_API_URL}/cstrength5`);
        const data = await response.json();
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        //const response = await fetch('http://localhost:5000/strength2');
        const response = await fetch(`${process.env.REACT_APP_API_URL}/cstrength6`);
        const data = await response.json();
  ...
  useEffect(() => {
    const fetchData = async () => {
      setIsLoading(true);
      try {
        const response = await fetch(`${process.env.REACT_APP_API_URL}/cstrength7`);
        const data = await response.json();
    ...
    <Container className="App" style={{ marginBottom: '100px' }}>
      ...
      <Row>
        <Col>
          ...
          <h1 style={{ margin: '20px 0' }}>Committed Strength - Iteration 4.3 - war_iter_4_3</h1>
          <LineGraph data={items4} /> {/* Pass data as props to LineChart */}
          <h1 style={{ margin: '20px 0' }}>Committed Strength - Iteration 4.4 - war_iter_4_4</h1>
          ...
          <h1 style={{ margin: '20px 0' }}>Committed strength - Live Trading - live_trading_multi_8</h1>
