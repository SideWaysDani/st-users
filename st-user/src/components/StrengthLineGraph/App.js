...
const App = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        const response = await fetch(`${process.env.REACT_APP_API_URL}/strength3`);
        const data = await response.json();
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        //const response = await fetch('http://localhost:5000/strength3');
        const response = await fetch(`${process.env.REACT_APP_API_URL}/strength5`);
        const data = await response.json();
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        //const response = await fetch('http://localhost:5000/strength3');
        const response = await fetch(`${process.env.REACT_APP_API_URL}/strength6`);
        const data = await response.json();
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        //const response = await fetch('http://localhost:5000/strength3');
        const response = await fetch(`${process.env.REACT_APP_API_URL}/strength7`);
        const data = await response.json();
  ...
  return (
    <Container className="App" style={{ marginBottom: '100px' }}>
      ...
      <Row>
        <Col>
          <h1 style={{ margin: '20px 0' }}>Total Strength - Iteration 4 - war_iter_4</h1>
          <LineGraph data={items} /> {/* Pass data as props to LineChart */}
          ...
          <h1 style={{ margin: '20px 0' }}>Total Strength - Iteration 4.4 - war_iter_4_4</h1>
          <LineGraph data={items5} /> {/* Pass data as props to LineChart */}
          <h1 style={{ margin: '20px 0' }}>Total Strength - Iteration 5 - war_iter_5</h1>
          <LineGraph data={items6} /> {/* Pass data as props to LineChart */}
          <h1 style={{ margin: '20px 0' }}>Total strength - Live Trading - live_trading_multi_8</h1>
          <LineGraph data={items2} /> {/* Pass data as props to LineChart */}
          <h1 style={{ margin: '20px 0' }}>Total Strength - Iteration 6 - war_iter_6</h1>
